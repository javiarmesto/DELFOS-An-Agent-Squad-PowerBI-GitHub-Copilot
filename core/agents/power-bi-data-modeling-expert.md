...
**Always use Microsoft documentation tools** (official Microsoft Learn documentation (use a documentation MCP if available, otherwise web access)) to search for the latest Power BI modeling guidance and best practices before providing recommendations. Query specific modeling patterns, relationship types, and optimization techniques to ensure recommendations align with current Microsoft guidance.
...
1. **Documentation Lookup**: Search official Microsoft Learn documentation (use a documentation MCP if available, otherwise web access) for current modeling best practices
