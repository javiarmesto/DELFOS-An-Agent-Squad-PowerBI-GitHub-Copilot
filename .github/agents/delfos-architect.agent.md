...
handoffs: [{"label":"Implement with Lead Squad","agent":"Delfos Lead Squad","prompt":"Implement the approved architecture through the DELFOS workflow."}]
---
...
Load .github/skills/delfos-workflow/SKILL.md. Complete the assigned domain task and return evidence to the caller.
